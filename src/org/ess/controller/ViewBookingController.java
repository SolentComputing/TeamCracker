...
public class ViewBookingController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources)
    {
        ...
        final Booking booking = MainController.getSelectedBooking();
        if(booking == null)
            return;
        serviceIDInput.setText(String.valueOf(booking.getServiceId()));
        serviceIDName.setText(booking.getServiceName());
        clientIDInput.setText(String.valueOf(booking.getClientId()));
        clientIDName.setText(booking.getClientName());
    ...
    private void onSave(final ActionEvent event)
    {
        if(onUpdateService() && onUpdateClient())
        {
            ...
            if(booking == null)
                return;
            booking.setServiceId(Integer.parseInt(serviceIDInput.getText()))
